...
```bash
connect-inapp-authn$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
connect-inapp-authn$ sam logs -n HelloWorldFunction --stack-name "connect-inapp-authn" --tail
```
